...
- **Collision Shape Previews**: `TesseraItem.collisionEditor()` returns a SwiftUI view with a fully-working editor that lets you build and export collision shapes visually. 
